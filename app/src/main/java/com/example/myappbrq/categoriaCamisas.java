...
public class categoriaCamisas extends AppCompatActivity {
    ...
    ImageButton ImgCamisaCamisaDry;
    ImageButton ImgCamisaCamisaTie;
    ImageButton ImgCamisaRetrowave;

    TextView TxtEspecificacaoCamisaDry;
    TextView TxtEspecificacaoCamisaTie;
    TextView TxtEspecificacaoCamisaRetrowave;

    TextView TxtPrecoCamisaDry;
    TextView TxtPrecoCamisaTie;
    TextView TxtPrecoCamisaRetrowave;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_categoria_camisas);
